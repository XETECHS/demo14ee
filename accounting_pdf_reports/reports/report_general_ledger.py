    ...
    def _get_account_move_entry(self, accounts, init_balance, sortby, display_account):
        ...
        for account in accounts:
            ...
            for move_line in res['move_lines']:
                if count_row in used_rows:
                    folio_accounts[count_row].append(move_line)
                else:
                    folio_accounts[count_row] = [move_line,]
                    used_rows.append(count_row)
                ...
                if count_line_it > 6:
                    ...
                    count_line_it += 1
            res['clean_move_lines'] = folio_accounts
